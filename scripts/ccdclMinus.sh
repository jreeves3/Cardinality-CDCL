...
then # CNF input formula
  ...
  # Run cardinality cadical on the permuted CNF, with a 5000 second timeout
  ./cardinality-cadical/build/cadical tmp/permuted.cnf tmp/solve.drat --no-binary -t 5000 > tmp/cadical.out
